...
def FillPopulation(): #membuat individu sebanyak POPULATION_SIZE
    individuals = {}
...
CFFP = CalcFitness(FillPopulation())

def SortPopulation(unsorted_calc_population): # mengurutkan masing masing individu secara descending berdasarkan poin fitness
...
print("\nUnsorted population : ")
for a,b in CFFP.items():
    print(a,b)

print("\nSorted population : ")
for a,b in SortPopulation(CFFP).items():
    print(a,b)